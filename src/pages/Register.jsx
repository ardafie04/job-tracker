...
export default function Register() {
    ...
    const { loading, error, setError, registerWithEmail, loginWithGoogle } = useAuth();
    ...
    return (
        <>
            ...
            <AuthLayout
                title="Daftar"
                subtitle="Buat akun gratis dan mulai lacak lamaran Anda"
            >
                {/* Error Message */}
                {error && (
